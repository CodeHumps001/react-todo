...
export default function Header({ hide, onHide }) {
  return (
    <header className="flex justify-between px-26 py-3 bg-transparent border-b border-gray-700 max-[782px]:px-5 max-[782px]: ">
      ...
      <button
        className="flex gap-2 px-10 py-3 bg-white/5 hover:shadow-lg text-white rounded-2xl justify-center items-center 
